    ...
    <main className="min-h-screen bg-slate-50 font-sans">
      <section className="relative bg-slate-900 pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="relative max-w-7xl mx-auto text-center z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-white tracking-tight mb-6"><span className="block text-amber-400 text-lg sm:text-xl font-sans font-bold tracking-widest uppercase mb-2">Premium Parking</span>{t.hero.title}</h1>
